...
class Ceremony(Spell):
    ...
    Coming of Age.
      You touch one humanoid who is a young adult. For the next 24
    ...
    Dedication.
      You touch one humanoid who wishes to be dedicated to your
    ...
    Funeral Rite.
      You touch one corpse, and for the next 7
